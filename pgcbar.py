...
if __name__ == '__main__':
    ...
    # make colormap
    # stops = np.r_[-2.0, 0.0, 1.0, 2.0]
    # colors = np.array([[0, 0, 1, 1], [0, 1, 0, 1], [0, 0, 0, 1], [1, 0, 0, 1]])

    stops = np.r_[-1.0, -0.5, 0.5]
    colors = np.array([[0, 0, 1, 1], [0, 1, 0, 1], [0, 0, 0, 1.0]])    
    cm = pg.ColorMap(stops, colors)
    
    # print cm.getGradient(p1=None,p2=None)
